...
public class DesignerHistoricoPage {
    ...
    public Parent getView() {
        VBox root = DesignerUiFactory.createPageContainer("Histórico de Designs");
        ...
        table.getColumns().addAll(codigo, cliente, produto, data, estado, acao);
        ...
        search.textProperty().addListener((obs, oldValue, newValue) -> {
            ...
            filtrados.setPredicate(pedido -> {
                ...
                return pedido.getCodigoEncomenda().toLowerCase().contains(termo)
                        ...
                        || pedido.getEstadoDesign().toLowerCase().contains(termo);
            });
        });
